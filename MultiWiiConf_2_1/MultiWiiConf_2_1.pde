...
Knob servoShaftDial[] = new Knob[8];
...
void create_checkboxes(String[] names) {
  ...
  System.out.println("# of Checkboxes: " + CHECKBOXITEMS);
...
void setup() {
  ...
  for(int i=0;i<8;i++) {
    motSlider[i]    = controlP5.addSlider("motSlider"+i,900,2000,1500,0,0,10,100);motSlider[i].setDecimalPrecision(0);
    servoSliderH[i]  = controlP5.addSlider("ServoH"+i,800,2200,1500,0,0,100,10);servoSliderH[i].setDecimalPrecision(0);
    servoSliderV[i]  = controlP5.addSlider("ServoV"+i,800,2200,1500,0,0,10,100);servoSliderV[i].setDecimalPrecision(0);
	servoShaftDial[i] = controlP5.addKnob("ServoD"+i,2200,800,1500,0,0,25);servoShaftDial[i].setAngleRange(PI*6/8);servoShaftDial[i].setStartAngle(PI*7/8);
		servoShaftDial[i].setNumberOfTickMarks(6);servoShaftDial[i].setTickMarkLength(4);servoShaftDial[i].setTickMarkWeight(2);
		servoShaftDial[i].showTickMarks(true);servoShaftDial[i].setShowAngleRange(false);servoShaftDial[i].setViewStyle(Knob.LINE); 
		//Knob.LINE, Knob.ELLIPSE or Knob.ARC 
		//servoShaftDial[i].setLabel(10);
  }
...
void draw() {
  ...
  for(i=0;i<8;i++) {
	...
	servoShaftDial[i].setValue(servo[i]);servoShaftDial[i].hide();
  }
...
//    ellipse(-size, -size, size, size);ellipse(+size, -size, size, size);
  ...
  }  else if (multiType == 57) { // Tricopter Flying-Wing Hybrid TRICOPTER_HYBRID_TYPE_A
    drawMotor(    0, +size, byteMP[0], 'L');
    drawMotor(+size, -size, byteMP[1], 'L');
    drawMotor(-size, -size, byteMP[2], 'R');
	//line(-size,-size, 0,0);line(+size,-size, 0,0);line(0,+size, 0,0);
    line(0,0+(0.4*size), 1.8*size,size+(0.4*size));line(1.8*size,size+(0.4*size),1.8*size,size-30+(0.4*size));  line(1.8*size,size-30+(0.4*size),0,-1.5*size+(0.4*size));
    line(0,0+(0.4*size), -1.8*size,+size+(0.4*size));line(-1.8*size,size+(0.4*size),-1.8*size,+size-30+(0.4*size));    line(-1.8*size,size-30+(0.4*size),0,-1.5*size+(0.4*size));
    noLights();text("HYBRID (AXIAL)", -40,-50);camera();popMatrix();

 
    motSlider[0].setPosition(xMot+50,yMot-15);motSlider[0].setHeight(50);motSlider[0].setCaptionLabel("REAR");motSlider[0].show();
    motSlider[1].setPosition(xMot+100,yMot-15);motSlider[1].setHeight(50);motSlider[1].setCaptionLabel(" ");motSlider[1].show(); //
    motSlider[2].setPosition(xMot,yMot-15);motSlider[2].setHeight(50);motSlider[2].setCaptionLabel(" ");motSlider[2].show(); //
    
	servoSliderV[0].setPosition(xMot,yMot+40);servoSliderV[0].setHeight(50);servoSliderV[0].setCaptionLabel("LEFT");servoSliderV[0].show(); 
    servoSliderV[1].setPosition(xMot+100,yMot+40);servoSliderV[1].setHeight(50);servoSliderV[1].setCaptionLabel("RIGHT");servoSliderV[1].show(); // Needs work
	servoSliderH[5].setPosition(xMot,yMot+115);servoSliderH[5].setCaptionLabel("YAW");servoSliderH[5].show(); 
	servoSliderH[2].setPosition(xMot,yMot+125);servoSliderH[2].setCaptionLabel("TILT");servoSliderH[2].show(); 
	servoSliderH[3].setPosition(xMot,yMot+135);servoSliderH[3].setCaptionLabel("MECH");servoSliderH[3].show(); 
  }  else if (multiType == 67) { // Tricopter Flying-Wing Hybrid TRICOPTER_HYBRID_TYPE_B
    drawMotor(    0, +size, byteMP[0], 'L');
    drawMotor(+size, -size, byteMP[1], 'L');
    drawMotor(-size, -size, byteMP[2], 'R');
	//line(-size,-size, 0,0);line(+size,-size, 0,0);line(0,+size, 0,0);
    line(0,0+(0.4*size), 1.8*size,size+(0.4*size));line(1.8*size,size+(0.4*size),1.8*size,size-30+(0.4*size));  line(1.8*size,size-30+(0.4*size),0,-1.5*size+(0.4*size));
    line(0,0+(0.4*size), -1.8*size,+size+(0.4*size));line(-1.8*size,size+(0.4*size),-1.8*size,+size-30+(0.4*size));    line(-1.8*size,size-30+(0.4*size),0,-1.5*size+(0.4*size));
    noLights();text("HYBRID (BICOPTER)", -40,-50);camera();popMatrix();

	
    // motSlider[0].setPosition(xMot+50,yMot-15);motSlider[0].setHeight(50);motSlider[0].setCaptionLabel("REAR");motSlider[0].show();
    // motSlider[1].setPosition(xMot+100,yMot-15);motSlider[1].setHeight(50);motSlider[1].setCaptionLabel(" ");motSlider[1].show(); //
    // motSlider[2].setPosition(xMot,yMot-15);motSlider[2].setHeight(50);motSlider[2].setCaptionLabel(" ");motSlider[2].show(); //
	// servoShaftDial[2].setPosition(xMot,yMot+50);servoShaftDial[2].setHeight(55);servoShaftDial[2].setCaptionLabel("LEFT");servoShaftDial[2].show(); 
		// servoShaftDial[2].setStartAngle(PI*11/8);
	// servoShaftDial[5].setPosition(xMot+100,yMot+50);servoShaftDial[5].setHeight(55);servoShaftDial[5].setCaptionLabel("RIGHT");servoShaftDial[5].show();
	
	// servoSliderH[2].setPosition(xMot,yMot+80);servoSliderH[2].setWidth(40);servoSliderH[2].setCaptionLabel(" ");servoSliderH[2].show();
    // servoSliderH[5].setPosition(xMot+100,yMot+80);servoSliderH[5].setWidth(40);servoSliderH[5].setCaptionLabel(" ");servoSliderH[5].show();
	
	// servoSliderH[0].setPosition(xMot,yMot+115);servoSliderH[0].setCaptionLabel("L ELVN");servoSliderH[0].show(); 
	// servoSliderH[1].setPosition(xMot,yMot+125);servoSliderH[1].setCaptionLabel("R ELVN");servoSliderH[1].show(); 
	// servoSliderH[3].setPosition(xMot,yMot+135);servoSliderH[3].setCaptionLabel("MECH");servoSliderH[3].show(); 
	
	motSlider[0].setPosition(xMot+50,yMot-15);motSlider[0].setHeight(50);motSlider[0].setCaptionLabel("REAR");motSlider[0].show();
    motSlider[1].setPosition(xMot+100,yMot-15);motSlider[1].setHeight(50);motSlider[1].setCaptionLabel(" ");motSlider[1].show(); //
    motSlider[2].setPosition(xMot,yMot-15);motSlider[2].setHeight(50);motSlider[2].setCaptionLabel(" ");motSlider[2].show(); //
	servoShaftDial[0].setPosition(xMot,yMot+50);servoShaftDial[0].setHeight(55);servoShaftDial[0].setCaptionLabel("LEFT");servoShaftDial[0].show(); 
		servoShaftDial[0].setStartAngle(PI*11/8);
	servoShaftDial[1].setPosition(xMot+100,yMot+50);servoShaftDial[1].setHeight(55);servoShaftDial[1].setCaptionLabel("RIGHT");servoShaftDial[1].show();
	
	servoSliderH[0].setPosition(xMot,yMot+80);servoSliderH[0].setWidth(40);servoSliderH[0].setCaptionLabel(" ");servoSliderH[0].show();
    servoSliderH[1].setPosition(xMot+100,yMot+80);servoSliderH[1].setWidth(40);servoSliderH[1].setCaptionLabel(" ");servoSliderH[1].show();
	
	servoSliderH[5].setPosition(xMot,yMot+115);servoSliderH[5].setCaptionLabel("L ELVN");servoSliderH[5].show(); 
	servoSliderH[2].setPosition(xMot,yMot+125);servoSliderH[2].setCaptionLabel("R ELVN");servoSliderH[2].show(); 
	servoSliderH[3].setPosition(xMot,yMot+135);servoSliderH[3].setCaptionLabel("MECH");servoSliderH[3].show(); 
  } else {
